# standard template that creates
# an empty black window of a given resolution
...
def get_color(): return (randrange(30, 250), randrange(30, 256), randrange(30, 256))
